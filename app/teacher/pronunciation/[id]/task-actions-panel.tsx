...
import { publishPronunciationTask, archivePronunciationTask } from "@/app/actions/pronunciation";
...
export function TaskActionsPanel({
  ...
  if (isArchived) {
    return <p className="text-sm text-slate-400">该任务已归档。</p>;
  }
    ...
    <div className="flex items-center gap-3">
        ...
        <button
          ...
          onClick={() => {
            ...
            startTransition(async () => {
              const result = await publishPronunciationTask(taskId);
      ...
      <button
        ...
        onClick={() => {
          setError(null);
          startTransition(async () => {
            const result = await archivePronunciationTask(taskId);
