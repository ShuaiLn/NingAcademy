...
// Colocated, not shared -- see the vocabulary variant's comment. This one
// has both a classes and a students section (assignment_targets carries
// either a class_id or a student_id, never both).
