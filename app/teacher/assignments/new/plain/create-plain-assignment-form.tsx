...
import { createAndPublishAssignment, type CreateAndPublishAssignmentResult } from "@/app/actions/assignments";
import { DueDateInput } from "@/app/_components/due-date-input";
import { TargetPicker } from "./target-picker";

const initialState: CreateAndPublishAssignmentResult = { ok: false, error: "" };

export function CreatePlainAssignmentForm({
  classes,
  students,
}: {
  ...
  const [state, formAction, pending] = useActionState(createAndPublishAssignment, initialState);
