...
const queue = [
  ...
  ["20260825200000_game_runtime_security_convergence.sql", null],
];
...
process.stdout.write(`Verified migrations 31-35 ordering, frozen 31-34 hashes, SECURITY DEFINER search paths, private grants, forward security convergence, and fail-closed approval inventory.\n`);
